...
namespace GAME.Scripts.MONETIZATION
{
    public class AdsManager : MonoBehaviour
    {
        ...
        private void AppLovin_OnFinishAds(bool IsFinished)
        {
            ...
            {
                // Debug.LogError("Ads Instigator was destroyed or nulled");
            }
        ...
        private void AppLovin_OnError(MaxSdkBase.AdInfo adInfo, MaxSdkBase.ErrorInfo EInfo, EAdType AdType)
        {
            ...
            bool bCancelRetry =
                EInfo.Code ==
                MaxSdkBase.ErrorCode
                    .DontKeepActivitiesEnabled // NOTE: User won't see any ads in this session anyway (Droid)
                || EInfo.Code ==
                MaxSdkBase.ErrorCode.FullscreenAdAlreadyShowing; // NOTE: Can't show ad if it's already showing
#else
            bool bCancelRetry =
        ...
        {
            AdInfo BannerInfo = new AdInfo("banner", EAdType.BANNER, bHasInternet,
                errInfo == null ? "available" : "not_available");
        ...
        /// </summary>
        public static EResultCode ShowRewarded(GameObject ObjectRef, UnityAction<bool> OnFinishAds,
            string Placement = "none")
        {
            ...
            {
                Debug.LogError("Ads Manager doesn't exist!");
            }
        ...
        public static EResultCode ShowInter(GameObject ObjectRef, UnityAction<bool> OnAdDismissed,
            string Placement = "none")
        {
            if (Exist)
            {
        ...
        /// </summary>
        public static EResultCode ShowInterForced(GameObject ObjectRef, UnityAction<bool> OnAdDismissed,
            string Placement = "none")
        {
            if (Exist)
            {
        ...
        public static bool HasLoadedAd(EAdType AdType)
        {
            if (Exist)
            {
                ...
                {
                    Debug.LogError("Can't use this for banners!");
                }
            }
        ...
        public static void ToggleBanner(bool bShow,
            MaxSdkBase.BannerPosition NewPosition = MaxSdkBase.BannerPosition.BottomCenter)
        {
            if (Exist)
            {
