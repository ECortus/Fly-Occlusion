...
public class RewardAfterFly : MonoBehaviour
{
    ...
    public void On()
    {
        ...
        defaultObject.SetActive(!Tutorial.Instance.Completed || GameManager.Instance.FlyLength <= 15f);
        rewardObject.SetActive(Tutorial.Instance.Completed && GameManager.Instance.FlyLength > 15f);
        ...
        IsOn = Tutorial.Instance.Completed;
        Angle = 0;
        Sign = 1;
