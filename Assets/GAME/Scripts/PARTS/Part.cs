...
public abstract class Part : MonoBehaviour
{
    ...
    public PartOrientation Orientation = PartOrientation.Default;
    ...
    public Vector3 GetOrientationAngles()
    {
        ...
        if (OverMergeField && _dragedPart && _dragedPart == this && !GameManager.Instance.GameStarted)
        {
    ...
    void ApplyOrientation()
    {
        ...
        transform.localEulerAngles = GetOrientationAngles();
    }
    ...
    public void AddMod()
    {
        ...
        ConnectedParts.Instance.Add(this);
    }
    
    public void RemoveMod()
    {
        ConnectedParts.Instance.Remove(this);
    ...
    void Update()
    {
        if (!GameManager.Instance.GameStarted)
        {
            ...
            {
                SwitchGridCollider(true);
                PlayerGrid.Instance.SetGridUILocalX(0);
            }
        }
    ...
    public virtual void CrashPart()
    {
        ...
        PlayerController.Instance.OnRepair -= RepairPart;
        PlayerController.Instance.OnCrash -= CrashPart;
    ...
    protected virtual void OnMouseDrag()
    {
        ...
        if (_dragedPart != null && _dragedPart == this)
        {
            ...
            if (selectedGrid)
            {
                PlayerGrid.Instance.UpdateRequireOrientationByPart(this, selectedGrid);
                ...
                if (PreShowOnPlayer)
                {
                                          ...
                                          && Orientations.HaveOrientation(PartOrientation.Front))
                    {
                        ...
                        PlayerGrid.Instance.UpdatePartParsOnGridOnlyRot(this, selectedGrid, true);
                        
                        // PlayerGrid.Instance.UpdatePartParsOnGridOnlyPos(this, selectedGrid, true);
                             ...
                             PlayerGrid.Instance.HaveOrientation(Orientations))
                    {
                        ...
                        SetMousePosition();
                        PlayerGrid.Instance.UpdatePartParsOnGridOnlyRot(this, selectedGrid);
                    }
                    else
                    {
                        // Debug.Log("third");
            ...
            if ((((!MergeCell.SelectedCell && !DeletePart.Selected) || Type.Category == PartCategory.Grid)
                && (!GridCell.SelectedCell
                    || (GridCell.SelectedCell.Part != null && GridCell.SelectedCell.Part != this
                    && Type.Category == PartCategory.Wings && GridCell.SelectedCell.AdditionalPart != null && GridCell.SelectedCell.AdditionalPart != this))
                || (!PlayerGrid.Instance.HaveOrientation(Orientations)) && !OverMergeField) || (OverMergeField && !MergeCell.SelectedCell))
            {
                ChangeColor(false);
                targetSize = 1.3f;
            }
    ...
    void SetMousePosition()
    {
        ...
        {
            if (Type.Category == PartCategory.Wheels && GridCell.SelectedCell.Part == null)
            {
                offset -= direction * 3f;
            }
            else if (GridCell.SelectedCell.Part == null
                     || (Type.Category == PartCategory.Wings && (GridCell.SelectedCell.AdditionalPart == null || GridCell.SelectedCell.AdditionalPart == this)))
            {
                offset -= direction * 1.5f;
            }
            else
            {
        ...
        if (_dragedPart != null && _dragedPart == this)
        {
            ...
            if (selectedGrid)
            {
                        ...
                        && Orientations.HaveOrientation(PartOrientation.Front))
                {
                    ...
                    PlayerGrid.Instance.UpdatePartParsOnGrid(this, selectedGrid);
                    SetDragedPart(null);
    ...
    {
        SetDefaultParsOnGridOnlyPos(pos, parent);
        
        AddMod();
        // OnPartPlaceOnGrid();
    }
    
    public void SetDefaultParsOnGridOnlyPos(Vector3 pos, Transform parent)
    {
        SwitchObjects(true);
        SwitchGridCollider(false);
    ...
    public void SetDefaultParsOnGridOnlyRot(Transform parent)
    {
        SwitchObjects(true);
        SwitchGridCollider(false);
    ...
    private bool Condition(GameObject go) =>
        go.layer == LayerMask.NameToLayer("Hit") && GameManager.Instance.GameStarted && PlayerController.Instance.Launched  && transform.parent != null;
