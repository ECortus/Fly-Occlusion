...
public class LaunchController : MonoBehaviour
{
    ...
    private Vector3 _defaultPos, currentPos;
    private Vector3 defaultPos => new Vector3(_defaultPos.x, toLaunch.Body.position.y, _defaultPos.z);
    ...
    void Update()
    {
        if (!PlayerController.Instance.Launched && GameManager.Instance.GameStarted)
        {
    ...
    public void StartLaunch()
    {
        ...
        _defaultPos = toLaunch.transform.position;
    ...
    public static Vector3 CorrectPos()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            if (cell && cell.Part)
            {
                ...
                else if (cell.Part.Type.Category == PartCategory.Wings)
                {
                    offsetZ += 2.5f;
                }
                else if (cell.Part.Type.Category == PartCategory.Wheels)
                {
                    offsetZ += 1.5f;
                }
                else
