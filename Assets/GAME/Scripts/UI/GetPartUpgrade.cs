...
public class GetPartUpgrade : MonoBehaviour
{
    ...
    private async void _ShowUpgrade(PartType type, int level)
    {
        ...
        if (type.Category == PartCategory.Boost)
        {
            ...
            description.text = $"Flight speed increased by {Mathf.RoundToInt(level * 10).ToString()}%";
        ...
        else if (type.Category == PartCategory.Wings)
        {
            ...
            description.text = $"Flight distance increased by {Mathf.RoundToInt(level * 10).ToString()}%";
        ...
        else if (type.Category == PartCategory.Wheels)
        {
            ...
            description.text = $"Takeoff speed increased by {Mathf.RoundToInt(level * 10).ToString()}%";
